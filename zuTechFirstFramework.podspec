...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of zuTechFirstFramework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zuyao1988@gmail.com/zuTechFirstFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zuyao1988@gmail.com' => 'tyaolee@liveperson.com' }
  s.source           = { :git => 'https://github.com/zuyao1988@gmail.com/zuTechFirstFramework.git', :tag => s.version.to_s }
